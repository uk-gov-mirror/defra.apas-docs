...
Inorganic fertiliser application and organic processes do not have emission factors and require the manual input of NO<sub>x</sub> and NH<sub>3</sub> emissions in kilograms per year (kg/y).
