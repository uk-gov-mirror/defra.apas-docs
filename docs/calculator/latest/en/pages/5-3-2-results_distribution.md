...
For the key, please refer to the map layer menu and click 'calculation results'. The colours, and hence the key, change whether you are viewing process contribution (PC), scenario contribution (SC) or in-combination process contribution (IPC) results. 
